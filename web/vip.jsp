...
<div class="mianCont">
    ...
    <div class="positions">
        ...
        &gt; <a href="Order" class="posCur">我的订单</a>
    </div><!--positions/-->
    <div class="cont">
        ...
        <div class="contRight">
            <h1 class="vipName"><span>用户名：</span><%=person.getName()%>  <strong class="vipUp">[点击修改/补充个人信息]</strong></h1>
            <table class="vipMy">
                <tr>
                    <th>用户名</th>
                    <th>联系方式</th>
            ...
            <form action="Person?type=update_do" method="post">
            <div class="address">
                <div class="addList">
                ...
                <div >
                    ...
                    <div><input type="radio" id="man" name="sex" value="男"/>
